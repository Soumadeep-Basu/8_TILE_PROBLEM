#DFS ALGO FOR SOLVING THE A-TILE PROBLEM
...
def Find_Path(State, k,  Max_Depth = DEPTH, Final = A_TILE_GOAL_STATE):
    ...
    if State == Final or k > Max_Depth:
        ...
        if State == Final:
            ...
            return State
    #check to see that we are not revisiting old states
    elif Visited.count(State) != 0:
        return State
...
def main():
    ...
    print("Report for the following execution of the exhaustive search : ")
    print()
    print(f" Number of visited nodes is (Number of Nodes that have been expanded) : {possible_states}")
    print()
    # print(" All the expnaded nodes in the order that they were recived are as follows : ")
    # print("========")


    #Commented out to reduce the complexity of the output, this will show the states in visitd if no path is found
